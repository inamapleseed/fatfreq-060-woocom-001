...
?>
	...
	<?php ob_start(); ?>
		...
		<div class="header-top">
			<div class="container">
				<span class="<?= $announcement_auto_running ? 'annoucement-txt block o-hidden' : '' ?>"><?=get_field('announcement', 'option'); ?></span>
			</div>
		</div>
		<?php 
		}
			...
			?>
				<div id="et-top-navigation" data-height="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>" data-fixed-height="<?php echo esc_attr( et_get_option( 'minimized_menu_height', '40' ) ); ?>">
					...
					<?php if ( ( false !== et_get_option( 'show_search_icon', true ) && ! $et_slide_header ) || is_customize_preview() ) : ?>
						...
						<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('My Account','woothemes'); ?>"><img src="<?=site_url();?>/wp-content/themes/Divi-child/img/user.png" alt="user"/></a>
						
						<a class="cart-custom" href="<?php echo wc_get_cart_url(); ?>" title="<?php _e( 'View your shopping cart' ); ?>">
							<img src="<?=site_url();?>/wp-content/themes/Divi-child/img/cart.png" alt="cart"/>
...
<?php if( have_rows('right_cta', 'option') ): ?>
<div class="right-cta-container">
<?php while( have_rows('right_cta', 'option') ): the_row();
$img_array = get_sub_field('icon');
?>
	<a href="<?php echo get_sub_field('link'); ?>" target="_blank"><img src="<?php echo esc_url($img_array['url']); ?>" alt="<?php echo esc_attr($img_array['alt']); ?>" /></a>
<?php endwhile; ?>
</div>
<?php endif; ?>
