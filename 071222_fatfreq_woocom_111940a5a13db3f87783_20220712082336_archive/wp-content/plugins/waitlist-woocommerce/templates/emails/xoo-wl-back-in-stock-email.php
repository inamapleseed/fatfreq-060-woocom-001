...
<table cellpadding="0" border="0" cellspacing="0" width="100%">
	<?php if( $heading ): ?>
		<tr>
			<td style="color: #000000; font-weight: bold; font-size: 19px; padding-bottom: 40px;" align="center"><?php echo $heading; ?></td>
		</tr>
	<?php endif; ?>
				...
				<tr>
					<td align="center" width="100%">
						...
						<table width="200" class="xoo-wl-table-full" align="right" cellpadding="0" border="0" cellspacing="0">
							<tr>
								<td align="center">
									<img height="auto" width="100%"  border="0" alt="<?php echo $product_name; ?>" src="<?php echo $product_image;  ?>" style="display: block; margin-left: auto; margin-right: auto;" class="xoo-wl-em-pimg"/>
								</td>
							</tr>
						</table>
						<?php endif; ?>
