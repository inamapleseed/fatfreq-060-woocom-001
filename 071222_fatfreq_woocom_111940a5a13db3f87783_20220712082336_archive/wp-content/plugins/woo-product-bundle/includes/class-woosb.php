...
if ( ! class_exists( 'WPCleverWoosb' ) && class_exists( 'WC_Product' ) ) {
	class WPCleverWoosb {
		...
		function woosb_wp_enqueue_scripts() {
			...
			$price_text = trim( get_option( '_woosb_bundle_price_text', esc_html__( 'Bundle price:', 'woo-product-bundle' ) ) );

			if ( empty( $price_text ) ) {
				$price_text = esc_html__( 'Bundle price:', 'woo-product-bundle' );
			}
			...
			wp_localize_script( 'woosb-frontend', 'woosb_vars', array(
					'alert_selection'          => esc_html__( 'Please select a purchasable variation for [name] before adding this bundle to the cart.', 'woo-product-bundle' ),
					'alert_empty'              => esc_html__( 'Please choose at least one product before adding this bundle to the cart.', 'woo-product-bundle' ),
					'alert_min'                => esc_html__( 'Please choose at least a total quantity of [min] products before adding this bundle to the cart.', 'woo-product-bundle' ),
					'alert_max'                => esc_html__( 'Sorry, you can only choose at max a total quantity of [max] products before adding this bundle to the cart.', 'woo-product-bundle' ),
