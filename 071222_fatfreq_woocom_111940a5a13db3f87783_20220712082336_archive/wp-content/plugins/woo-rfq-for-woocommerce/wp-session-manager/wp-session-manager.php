...
if (!defined('RFQTK_WP_SESSION_EXPIRATION_VARIANT')) {
    DEFINE('RFQTK_WP_SESSION_EXPIRATION_VARIANT', 60 * 60 * 24 * 29);

}

if (!defined('RFQTK_WP_SESSION_EXPIRATION')) {
    DEFINE('RFQTK_WP_SESSION_EXPIRATION', 60 * 60 * 24 * 30);

}
if (!defined('RFQTK_WP_SESSION_CLEAN_LIMIT')) {
    DEFINE('RFQTK_WP_SESSION_CLEAN_LIMIT', 100000);//clean up this many records during each garbage collection
}
