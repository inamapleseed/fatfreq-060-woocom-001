	...
	$.Popup = function(settings)
	{
		...
		var p = this,
			defaults = {
				...
				// Markup
				backClass : 'vpc_popup_back',
				backOpacity : 0.7,
				containerClass : 'vpc_popup_cont',
				closeContent : '<div class="vpc_popup_close">&times;</div>',
				markup : '<div class="vpc_popup"><div class="vpc_popup_content"/></div>',
				contentClass : 'vpc_popup_content',
				preloaderContent : '<p class="preloader">Loading</p>',
				activeClass : 'vpc_popup_active',
				hideFlash : false,
				speed : 200,
				popupPlaceholderClass : 'vpc_popup_placeholder',
