	...
	<?php
		if ( has_post_thumbnail() ) 
		{
			...
			foreach( $attachment_ids as $attachment_id ) {
			   ...
			   $html .= '<div class="zoom"><img src="'.$imgfull_src[0].'" class="skip-ao-lazyload" /><img src="'.$image_src[0].'" class="skip-ao-lazyload" /><a href="'.$imgfull_src[0].'" class="wpgis-popup fa fa-expand" data-fancybox="product-gallery"></a></div>';
			}
