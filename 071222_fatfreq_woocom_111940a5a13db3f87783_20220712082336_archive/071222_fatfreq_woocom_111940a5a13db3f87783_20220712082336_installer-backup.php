...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '071222_fatfreq_woocom_111940a5a13db3f87783_20220712082336_archive.zip';
	const ARCHIVE_SIZE		 = '213371108';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '111940a-12082336';
    const SECONDARY_PACKAGE_HASH = 'ff1f1e4-12082336';
	const VERSION			 = '1.4.2';
